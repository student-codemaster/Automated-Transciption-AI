...
if not st.session_state.analysis_complete:
    ...
    if st.session_state.get("audio_path"):
        ...
        if os.path.exists(segment_json):
            ...
            st.download_button("Download segments JSON", data=clean_json_data, file_name=f"{episode_id}.json", mime="application/json")
    ...
    with st.sidebar:
        ...
        page = st.radio(
            "Choose a view:",
            [" Transcript", " Search", "Analytics", " Timeline", " Keywords", " Sentiment"],
            index=0,
    ...
    if page == " Transcript":
        ...
        with chart_col1:
            st.subheader("Segment Duration Distribution")
        ...
        with chart_col4:
            st.subheader(" Keywords per Segment")
        ...
        st.header(" Keyword Analysis & Insights")
